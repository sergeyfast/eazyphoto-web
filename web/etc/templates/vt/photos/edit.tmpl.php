<?php
    ...
    $__pageTitle = LocaleLoader::Translate( "vt.screens.photo.editTitle");
	...
	$__breadcrumbs = array( 
		array( 'link' => Site::GetWebPath( "vt://photos/" ) , 'title' => LocaleLoader::Translate( "vt.screens.photo.list" ) )
		, array( 'link' => Site::GetWebPath( "vt://photos/edit/" . $objectId ) , 'title' => LocaleLoader::Translate( "vt.common.crumbEdit" ) ) 
	);
?>
...
<div class="main">
	<div class="inner">
		<form method="post" action="" enctype="multipart/form-data" data-object-id="{$objectId}" id="data-form">
			...
			<div class="buttons">
				<a href="{web:vt://photos/}" class="back">&larr; {lang:vt.common.back}</a>
