<?php
    ...
    $grid = [
        'columns'     => [
            ...
            T( 'vt.photo.isFavorite' ),
            T( 'vt.photo.statusId' ),
        ],
        'colspans'    => [ 0 => 2 ],
        'sorts'       => [ 0 => 'album.title', 1 => 'originalName', 2 => 'orderNumber', 3 => 'photoDate', 4 => 'isFavorite', 5 => 'statusId', ],
        'operations'  => true,
        'allowAdd'    => true,
...
<main role="main">
            ...
            <div class="plate cont">
                <div class="form fsMedium">
                    ...
                    <div id="ExtendedSearch" class="displayNone" style="display: none;">
                        ...
                        <div class="row _fluid _p">
                            <div class="col6 offset3"><?= FormHelper::FormCheckBox( 'search[isFavorite]', 'true', 'isFavorite', null, $search['isFavorite'] ); ?> <label for="isFavorite" class="blockLabel _shiftToRight">{lang:vt.photo.isFavorite}</label></div>
                        </div>
                        <div class="row _fluid _p">
    ...
    ?>
                <tr data-object-id="{$id}">
                    <td><img src="<?= LinkUtility::GetPhotoThumb( $object, true ) ?>" width="40"></td>
                    ...
                    <td><?= StatusUtility::GetBoolTemplate( $object->isFavorite ) ?></td>
