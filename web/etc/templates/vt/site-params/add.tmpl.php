<?php
    ...
    $__pageTitle   = T( 'vt.screens.siteParam.addTitle' );
    $__breadcrumbs = [
        [ 'link' => Site::GetWebPath( 'vt://site-params/' ), 'title' => T( 'vt.screens.siteParam.list' ) ],
        [ 'link' => Site::GetWebPath( 'vt://site-params/add' ), 'title' => T( 'vt.common.crumbAdd' ) ],
    ];
?>
...
<main role="main">
    ...
    <div class="container"><a href="{web:vt://site-params/}" class="linkBlock cLink fsBigX floatRight">← <span class="link">{lang:vt.common.back}</span></a>
        <h1>{$__pageTitle}</h1>
        <form method="post" action="{web:vt://site-params/}add" enctype="multipart/form-data" id="data-form">
