<?php
    ...
    $__pageTitle   = T( 'vt.screens.album.addTitle' );
    $__breadcrumbs = [
        [ 'link' => Site::GetWebPath( 'vt://albums/' ), 'title' => T( 'vt.screens.album.list' ) ],
        [ 'link' => Site::GetWebPath( 'vt://albums/add' ), 'title' => T( 'vt.common.crumbAdd' ) ],
    ];
?>
...
<main role="main">
    ...
    <div class="container"><a href="{web:vt://albums/}" class="linkBlock cLink fsBigX floatRight">← <span class="link">{lang:vt.common.back}</span></a>
        <h1>{$__pageTitle}</h1>
        <form method="post" action="{web:vt://albums/}add" enctype="multipart/form-data" id="data-form">
